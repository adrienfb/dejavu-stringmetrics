...
/**
 * L2 distance implementation based on a vector model. This distance is also referred to as euclidean distance.
 * This implementation uses the formula: l2 = sqrt( sum( (A_i - B_i)^2 ,i=0..n) )
 * where A and B are term frequency vectors. </br>
 * 
 * <p>For creation please use default L2Distance or the Builder {@link Builder} provided by the static methods.</p>
 * 
...
public class L2Distance extends VectorSimilarity implements DistanceMetric, SimilarityMetric {
	...
	/**
	 * L2Distance Builder
	 * Restriction: takeKeyset must be false since L2 distance is based on term frequency.
	 * 
