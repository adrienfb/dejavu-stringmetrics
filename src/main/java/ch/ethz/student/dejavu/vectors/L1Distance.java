...
/**
 * L1 distance implementation based on a vector model. This distance is also referred to as block distance or Manhattan distance.
 * This implementation uses the formula: l1 = sum( |A_i - B_i| ,i=0..n)
 * where A and B are term frequency vectors. </br>
 * Sums up the absolute difference between the term frequencies of both strings.
 * 
 * <p>For creation please use default L1Distance or the Builder {@link Builder} provided by the static methods.</p>
 * 
...
public class L1Distance extends VectorSimilarity implements DistanceMetric, SimilarityMetric {
	...
	/**
	 * L1Distance Builder
	 * Restriction: takeKeyset must be false since L1 distance is based on term frequency.
	 * 
