...
/**
 * Cosine distance implementation based on a vector model. 
 * This implementation uses the formula: cosineDistance = A * B / ( ||A|| * ||B||)
 * where A and B are term frequency vectors. </br>
 * Thus A * B is a dot product and ||.|| is the euclidean norm of the frequency vector
 * 
 * <p>For creation please use default CosineDistance or the Builder {@link Builder} provided by the static methods.</p>
 * 
...
public class CosineDistance extends VectorSimilarity implements UnnormalizedSimilarityMetric{
	...
	/**
	 * @return	standard cosine distance that can be used to determine the cosine distance of two strings.
	 * @see CosineDistance
	 */
	...
	/**
	 * CosineDistance Builder
	 * Restriction: takeKeyset must be false since cosine distance is based on term frequency.
	 * 
