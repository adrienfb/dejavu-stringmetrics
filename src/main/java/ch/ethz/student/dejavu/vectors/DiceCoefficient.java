...
/**
 * Dice Coefficient implementation based on a vector model. This implementation uses the formula:
 * diceCofficient = 2*intersect(A, B) / ( |A| + |B| ) where A and B are sets of tokens. </br> |.| is
 * the size of the token set.
 *
...
public class DiceCoefficient extends VectorSimilarity implements SimilarityMetric {
  ...
  /**
   * @return standard dice coefficient that can be used to determine the dice coefficient of two
   * strings.
   * @see DiceCoefficient
   */
  ...
  /**
   * DiceCoefficient Builder No further restrictions or additional parameters.
   *
