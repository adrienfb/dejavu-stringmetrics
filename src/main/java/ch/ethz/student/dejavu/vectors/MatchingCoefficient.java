...
/**
 * Matching coefficient implementation based on a vector model. 
 * This implementation uses the formula: matchingCoefficient = intersection (A, B)
 ...
 *
 */
public class MatchingCoefficient extends VectorSimilarity implements UnnormalizedSimilarityMetric, SimilarityMetric {
	...
	/**
	 * @return	standard matching coefficient that can be used to determine the matching coefficient of two strings.
	 * @see DiceCoefficient
	 */
