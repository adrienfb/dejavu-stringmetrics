 ...
 * 
 * <p>For creation please use default distance or the Builder {@link Builder} provided by the static methods.</p>
 * 
 * <p>You can either generate the code from an input string, using method code() or compare the codes computed form two input strings by
 * 		using method similarity(), the default distance method used for comparing the codes is the Hamming distance (other distances can be
 * 		specified when using object instantiation through the provided builder)
 * </p>
 * 	TODO: update no more similarity -> get codes and use other metrics
 * 
...
public class SoundexMetric {
	...
	/**
	 * @return	standard Soundex distance object that can be used to determine the distance between two strings
	 * @see JaroMetric
	 */
