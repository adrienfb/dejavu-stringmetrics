 ...
 *
 * <p>For creation please use default JaroWinklerDistance or the Builder {@link Builder} provided by
...
public class JaroWinklerMetric implements SimilarityMetric {
  ...
  /**
   * @return standard JaroWinkler distance object that can be used to determine the distance between
   * two strings
   * @see JaroMetric
   */
   ...
   * JaroWinkler Builder
   *
   * <p>Note that setting either prefixLength or scalingFactor to zero computes the standard Jaro
   * distance</p>
   *
