...
/**
 * The Needleman-Wunsch algorithm performs a global alignment on two sequences. It is commonly used
 * in bioinformatics to align protein or nucleotide sequences. The algorithm was published in 1970
...
public class NeedlemanWunschDistance implements DistanceMetric, SimilarityMetric {
  ...
  public static class Builder {
    ...
    /**
     * Similarity Matrix, any matrix with similarity values for the alphabet, If a character is not
     * found in the matrix then the normal match, mismatch score is used
     *
