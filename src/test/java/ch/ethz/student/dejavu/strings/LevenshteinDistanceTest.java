...
public class LevenshteinDistanceTest extends AbstractDistanceAndSimilarityMetricTest {
	private static final LevenshteinDistance metric = LevenshteinDistance.getInstance();
